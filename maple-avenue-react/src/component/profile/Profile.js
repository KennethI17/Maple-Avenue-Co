...
function Profile() {
  ...
  useEffect(
    () => {
      const params = { email: localStorage.getItem("loggedInUser") };
      axios
        .get("http://localhost:8080/findUserEmail", { params })
        .then((response) => {
          // Spring returns a User object hence we save in the state variable called user
          setLoggedInUser(response.data);
        })
        .catch((error) => {});
    },
    [] // This argument allows a render when this variable updates. Since we only want to call
    // this function once when the component loads, no need to add a tracking variable.
  );

  return (
    <div className="sign-up-container container-fluid home-margin-top-less-200px">
      <div className="row">
        <nav className="col-md-2 d-none d-md-block bg-light sidebar">
          <div className="sidebar-sticky">
            <ul className="nav flex-column">
              ...
              <li className="nav-item">
                <Link className="nav-link" to="/home/store">
                  <svg
        ...
        <main role="main" className="col-md-9 ml-sm-auto col-lg-10 px-4">
          ...
          <div className="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
            <h1 className="h2">{loggedInUser.firstName}'s Profile</h1>
          </div>
          {/* <Route path="/home/student-life">
            <StudentLife allStudents={allStudents} />
          </Route> */}
        </main>
      </div>
    </div>
